  ...
  return (
    <div className="flex flex-col min-h-screen">
      <SEO
        ...
        description={
          genre
            ? `Browse and stream ${genre.name} movies free on JOKER MOVIES. Discover the best ${genre.name.toLowerCase()} films, from classics to new releases.`
            : 'Browse and stream trending movies free on JOKER MOVIES. Discover the most popular, top-rated, and newest films across all genres.'
        }
        url={`https://www.jokermovies.app${buildBrowsePath('movie', genreId)}`}
      />
