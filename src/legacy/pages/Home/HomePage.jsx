...
export default function HomePage() {
  ...
  return (
    ...
    >
      <SEO
        title="JOKER MOVIES — Stream Movies & TV Shows"
        description="Watch trending movies and TV shows for free. Browse by genre, discover new releases, and stream instantly on JOKER MOVIES — powered by TMDB."
        noSuffix
      />
      
      {/* ── Visually Hidden H1 for SEO (Brand Keyword 'JOKER MOVIES') ── */}
      <h1 className="sr-only">JOKER MOVIES - Free Movie & TV Show Streaming Platform</h1>
