...
const SITE_NAME = 'JOKER MOVIES';
const SITE_URL  = import.meta.env.VITE_SITE_URL || 'https://www.jokermovies.app';
const DEFAULT_IMAGE = `${SITE_URL}/joker-preview.png`;

/**
 * Reusable SEO component.
 *
 * Props:
 *  title        – page title (appended with " | JOKER MOVIES" unless noSuffix)
