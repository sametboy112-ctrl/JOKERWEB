...
const CONFIG = {
  API_KEY: (import.meta.env.VITE_TMDB_API || "f66eb21a452b1501f2ac555e2cff7ffc"),
  ...
  return (
    ...
    >
      <SEO
        ...
        description={
          debouncedQuery
            ? `Search results for "${debouncedQuery}" on JOKER MOVIES.`
            : 'Search and browse movies & TV shows by genre, year, and rating on JOKER MOVIES.'
        }
      />
